          ...
          <?php if (!empty($nominas)): ?>
            <?php foreach ($nominas as $nomina): ?>
              <tr>
                ...
                <td><?= esc($nomina->nombre_empleado); ?> <small class="text-muted">(<?= esc($nomina->nombre_usuario); ?>)</small></td>
                ...
                <td>
                  <a href="<?= base_url('nomina/editar/' . $nomina->id_nomina); ?>" class="btn btn-sm btn-primary">
                    <i class="fa-solid fa-pen-to-square"></i>
                  </a>
                  <a href="<?= base_url('nomina/eliminar/' . $nomina->id_nomina); ?>" 
                     class="btn btn-sm btn-danger"
                     onclick="return confirm('¿Desea eliminar esta nómina?');">
